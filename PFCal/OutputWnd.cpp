...
{
	m_wndOutputBuild.AddString(_T("Power Flow Calculation"));
	m_wndOutputBuild.AddString(_T("The output will be displayed here."));
	m_wndOutputBuild.AddString(_T("Beijing Institute of Technology"));
}
